...
/**
* Returns an accumulator function which incrementally computes moving minimum and maximum absolute values, ignoring `NaN` values.
*
* ## Notes
*
...
*
* @example
* var accumulator = incrnanmminmaxabs( [ 0.0, 0.0 ], 3 );
*
* var mm = accumulator();
* // returns null
*
...
* // returns [ 3.0, 5.0 ]
*/
declare function incrnanmminmaxabs( out: ArrayLike<number>, window: number ): accumulator;
...
* // returns [ 3.0, 5.0 ]
*/
declare function incrnanmminmaxabs( window: number ): accumulator;


// EXPORTS //

export = incrnanmminmaxabs;
